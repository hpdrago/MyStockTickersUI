...
{
    /**
     * Convert the int modelObjectRows to the name of the enum.
    ...
    export function getName( intValue: number )
    {
        switch( intValue )
        {
            ...
            default:
                return  intValue + " is an invalid modelObjectRows";
        }
    }

    /**
     * Returns true if all available modelObjectRows will be loaded.
